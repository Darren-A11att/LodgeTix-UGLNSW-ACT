...
export default function HeadingsPageHeadingsWithMetaActionsAndBreadcrumbsOnDark() {
  return (
    <div className="lg:flex lg:items-center lg:justify-between">
      ...
      <div className="mt-5 flex lg:mt-0 lg:ml-4">
        ...
        <Menu as="div" className="relative ml-3 sm:hidden">
          ...
          <MenuItems
            transition
            className="absolute left-0 z-10 mt-2 -ml-1 w-48 origin-top-left rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 transition focus:outline-hidden data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
          >
            <MenuItem>
              <a
                href="#"
