export default function SectionsFeatureSectionsWithLargeBorderedScreenshotOnDark() {
  return (
    <div className="overflow-hidden bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative mt-16 aspect-2432/1442 h-[36rem] sm:h-auto sm:w-[calc(var(--container-7xl)-calc(var(--spacing)*16))]">
          <div className="absolute -inset-2 rounded-[calc(var(--radius-xl)+calc(var(--spacing)*2))] bg-white/[2.5%] shadow-[inset_0_0_2px_1px_rgb(255_255_255/2.5%)] ring-1 ring-white/10" />
          <img
            alt=""
